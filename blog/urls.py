...
from .views import HomeView, PostDetailView, AddPostView, UpdatePostView, DeletePostView, CategoryView, LoadMore, SearchPosts
...
urlpatterns = [
    ...
    path('search_posts/', SearchPosts, name='search-posts'),
]
